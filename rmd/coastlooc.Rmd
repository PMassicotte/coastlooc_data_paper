...
-   Original data had background averaged calculated between 745 and 750 nm. This average background have been re-added to the spectra. Thereafter, a new averaged background value has been calculated between 746 and 750 nm and subtracted from the spectra.
...
-   Extracted extra variables (`DOC`, `AQY`) in Massimo 2000.
...
Comparing `acdom443` for the different areas. There is a clear open to coastal gradient pattern among the areas.
