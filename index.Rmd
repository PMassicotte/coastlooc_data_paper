...
I have extracted the bathymetry at each sampling locations. This boxplot provide a general picture of the bathymetry per area.
...
Figure 2: Overview of the temporal sampling for the seven areas. The numbers in the circles indicate the number of visited stations each month.
...
-   Zoom on geographic ares such as figure 13 in the final report.
