...
ggsave(
  here("graphs", "06_histogram_raw_reflectance.pdf"),
  device = cairo_pdf,
  width = 7,
  height = 5
)
...
ggsave(
  here("graphs", "06_histogram_reflectance_values_outside_0_1_removed.pdf"),
  device = cairo_pdf,
  width = 7,
  height = 5
)
...
save_fun(p_reflectance, here("graphs", "06_reflectance_profiles_by_area.pdf"))
