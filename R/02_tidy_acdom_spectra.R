...
ggsave(
  here("graphs", "02_raw_and_background_corrected_acdom_spectra.pdf"),
  device = cairo_pdf,
  height = 8,
  width = 10
)
...
cairo_pdf(
  here("graphs", "02_fitted_acdom_spectra_ordered_from_best_to_worst_fits.pdf"),
  width = 7,
  height = 5,
  onefile = TRUE
)
...
ggsave(
  here("graphs", "02_worst_fitted_acdom_spectra.pdf"),
  device = cairo_pdf,
  width = 12,
  height = 10
)
