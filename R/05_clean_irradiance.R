...
ggsave(
  here("graphs", "05_histogram_raw_irradiance.pdf"),
  device = cairo_pdf,
  width = 24,
  height = 10
)
...
ggsave(
  here("graphs", "05_histogram_irradiance_negative_values_removed.pdf"),
  device = cairo_pdf,
  width = 24,
  height = 10
)
...
save_fun(p_eu, here("graphs", "05_eu_spectral_profiles_by_area.pdf"))
save_fun(p_ed, here("graphs", "05_ed_spectral_profiles_by_area.pdf"))
save_fun(p_ku, here("graphs", "05_ku_spectral_profiles_by_area.pdf"))
save_fun(p_kd, here("graphs", "05_kd_spectral_profiles_by_area.pdf"))
